...
//ye dono name fix rhenge:

// Each page.tsx file represents a route.
//The folder name becomes part of the URL path.


//layout.tsx file to create UI that is shared between multiple pages.
//A shared wrapper for the pages inside the same folder
//Automatically wraps the matching page.tsx in same directory
